...
class MesacneHlasovanie extends StatefulWidget{

  @override
  State<MesacneHlasovanie> createState() => MesacneHlasovanieState();
}


class MesacneHlasovanieState extends State<MesacneHlasovanie> {
